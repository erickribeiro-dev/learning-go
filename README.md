...
- [Main fuction](src/main.go) - Entry point of execution
...
- [Structs tags](src/structsTags.go) - Structs tags
...
- [Channels](src/channels.go) - Sending values to Goroutines through channels
